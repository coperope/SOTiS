...
export const GET_ALL_KNOWLEDGE_SPACES = (professor_id: string, flag: string) => `/professor/${professor_id}/knowledge_space/real/${flag}`
...
export const GET_PROFESSOR_KNOWLEDGE_SPACES = (professor_id: string, flag: string) => `/professor/${professor_id}/knowledge_space/real/${flag}`
