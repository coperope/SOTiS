...
import { Answer } from '../../CreateTest'
import { useStyles } from '../styles'
import DeleteIcon from '@material-ui/icons/Delete';
import { Grid, Checkbox, FormControl, InputLabel, Input, IconButton, FormControlLabel, Box } from '@material-ui/core';
  ...
  return <div className={[classes.answerPanel, classes.root].join(' ')}>
    <Box boxShadow={0}>
      <Grid container spacing={2}>
        ...
        <Grid item xs={2}>
          <IconButton className={classes.button} onClick={() => removeAnswer()}>
            <DeleteIcon />
          </IconButton >
        </Grid>
      </Grid>
